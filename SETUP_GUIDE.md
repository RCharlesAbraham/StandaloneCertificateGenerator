...
├── index.html                 # Certificate generator (main app)
├── login.html                 # User login page
├── login_process.php          # User authentication
├── logout.php                 # Logout handler
├── log_certificate.php        # Certificate logging
...
- Check `log_certificate.php` is accessible
...
- **POST** `/register_process.php` - User registration
- **POST** `/logout.php` - User logout
- **POST** `/log_certificate.php` - Log certificate generation

### Admin APIs
- **POST** `/admin_login_process.php` - Admin login
- **GET** `/admin_api.php?action=dashboard` - Dashboard stats
- **GET** `/admin_api.php?action=users` - All users
- **GET** `/admin_api.php?action=certificates` - Certificate logs
- **GET** `/admin_api.php?action=activity` - Activity logs
- **GET** `/admin_api.php?action=sessions` - Active sessions
